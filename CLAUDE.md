...
- Model: GOLD (pivoted from garnet, D9), binary XGBoost, pseudo-absence sampling (PU setup), spatial-block CV — never random splits.
...
- Jul 16 ✅ Session A: gold positives table (479, D6/D9), cache module live
